...
public class CameraActivity extends Activity{
    ...
    * @return
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.takepicture);
        View view = (View) findViewById(R.id.camera_preview);
    ...
    private boolean safeCameraOpenInView(View view) {
        ...
        if(qOpened == true){
            mPreview = new CameraPreview(this.getBaseContext(), mCamera, previewCb,autoFocusCB, mCameraView);
            FrameLayout preview = (FrameLayout) view.findViewById(R.id.camera_preview);
            preview.addView(mPreview);
            mCamera.setPreviewCallback(previewCb);
            Toast.makeText(this, "Start camera preview", Toast.LENGTH_SHORT);
